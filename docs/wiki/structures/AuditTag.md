---
title: AuditTag
original: https://code.google.com/p/unfinnigan/wiki/AuditTag
updated: 2011-03-28 04:47:53
...
| --- | --- | --- | --- | --- |
| 0 | 8 | [TimestampWin64](TimestampWin64.md) | `time` | 1996-05-05 01:31:23 |
| 8 | 50 | UTF16LE | `tag[1]` | linda |
| 58 | 50 | UTF16LE | `tag[2]` | linda |
| 108 | 4 | UInt32 | `unknown_long` | 0 |

> **Note**: The timestamp seems to represent the local time. A UTC timestamp corresponding to it is located in [RawFileInfoPreamble](RawFileInfoPreamble.md).
