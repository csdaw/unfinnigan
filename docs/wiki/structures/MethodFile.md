---
title: MethodFile
original: https://code.google.com/p/unfinnigan/wiki/MethodFile
updated: 2011-03-28 14:20:02
...
| 4026 | 92 | [PascalStringWin32](PascalStringWin32.md) | `orig file name` | `C:\DOCUME~1\MANNLA~1\LOCALS~1\Temp\MTH65.tmp` |
| 4118 | 4 | UInt32 | `n` | `1` |
| 4122 | 44 | [PascalStringWin32](PascalStringWin32.md) | `name trans` | `LTQ Orbitrap MS, LTQ` |
| 4166 | 2176 | OLE2File | `container` | `Windows Compound Binary File: 5 nodes` |

### Example 2 (two pairs)

| offset | size | type | key | value |
| --- | --- | --- | --- | --- |
| 2984 | 1356 | [FileHeader](FileHeader.md) | `header` | `V.63; 2008-04-30 14:12:52; LTQ Orbitrap` |
| 4340 | 4 | UInt32 | `file size` | `34304` |
| 4344 | 86 | [PascalStringWin32](PascalStringWin32.md) | `orig file name` | `C:\DOCUME~1\LTQ\LOCALS~1\Temp\MTH1F5E.tmp` |
| 4430 | 4 | UInt32 | `n` | `4` |
| 4434 | 346 | [PascalStringWin32](PascalStringWin32.md) | `name trans` | `LTQ Orbitrap MS, LTQ, Eksigent LC Channel 1, EksigentNanoLcCom_DLL, Eksigent LC Channel 2, EksigentNanoLc_Channel2, Eksigent NanoLC-AS1 Autosampler, NanoLC-AS1 Autosampler` |
| 4780 | 3712 | OLE2File | `container` | `Windows Compound Binary File: 13 nodes` |
...
Decoding it in perl is not straightforward either. The [Finnigan::MethodFile](../decoder-api/FinniganMethodFile.md) decoder was one of the last to be written and I did not have time to add a new method to [Finnigan::Decoder](../decoder-api/FinniganDecoder.md) to decode a set of key-value pairs. Instead, I stashed them in a list, to be converted into a hash with the accessor method.
