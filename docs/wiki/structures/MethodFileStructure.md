---
title: MethodFileStructure
original: https://code.google.com/p/unfinnigan/wiki/MethodFileStructure
updated: 2011-03-28 13:40:43
...
![](../images/method_file_structure.png)
...
| 1360 | 86 | [PascalStringWin32](PascalStringWin32.md) | `orig file name` | `C:\DOCUME~1\LTQ\LOCALS~1\Temp\MTH1F5E.tmp` |
| 1446 | 4 | UInt32 | `n` | `4` |
| 1450 | 346 | [PascalStringWin32](PascalStringWin32.md) | `name trans` | `LTQ Orbitrap MS, LTQ, Eksigent LC Channel 1, EksigentNanoLcCom_DLL, Eksigent LC Channel 2, EksigentNanoLc_Channel2, Eksigent NanoLC-AS1 Autosampler, NanoLC-AS1 Autosampler` |
| 1796 | 3712 | [OLE2File](../decoder-api/FinniganOLE2File.md) | `container` | `Windows Compound Binary File: 13 nodes` |
