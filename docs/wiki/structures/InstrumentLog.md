---
title: InstrumentLog
original: https://code.google.com/p/unfinnigan/wiki/InstrumentLog
updated: 2011-04-02 14:52:07
...
The content of the record (besides the timestamp) is designed to be decoded with the [GenericDataHeader](GenericDataHeader.md) mechanism.

## Structure

| [GenericDataHeader](GenericDataHeader.md) (loaded with `InstrumentLog` descriptors) |
| --- |
| [InstrumentLogRecord](InstrumentLogRecord.md) 1 = {timestamp, [GenericRecord](GenericRecord.md)} |
| . . . |
| [InstrumentLogRecord](InstrumentLogRecord.md) *n* = {timestamp, [GenericRecord](GenericRecord.md)} |

The number of records in the instrument log and the seek address of the first [InstrumentLogRecord](InstrumentLogRecord.md) in the file are contained in [SampleInfo](SampleInfo.md), which is prat of [RunHeader](RunHeader.md).
...
[The overview of the file layout](../overview/FileLayoutOverview.md)
