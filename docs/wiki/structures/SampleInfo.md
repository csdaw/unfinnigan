---
title: SampleInfo
original: https://code.google.com/p/unfinnigan/wiki/SampleInfo
updated: 2010-03-09 06:54:53
author: selko...@gmail.com
source: Internet Archive copy of Google Code wiki
---

SampleInfo is a static (fixed-size) binary preamble to [RunHeader](RunHeader.md) containing data stream lengths and addresses, as well as some unidentified data. All data streams in the file, except for the list of ScanHeader records and TrailerScanEvent stream have their addresses stored in SampleInfo.

The addresses of the ScanHeader and TrailerScanEvent streams are stored in the parent structure, [RunHeader](RunHeader.md).

It appears as though [RunHeader](RunHeader.md) is a recently introduced wrapper around the older SampleInfo structure.
...
| 88 | 56 | [RawBytes](RawBytes.md) | `unknown area` | `0` |
