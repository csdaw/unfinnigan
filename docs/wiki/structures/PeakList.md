---
title: PeakList
original: https://code.google.com/p/unfinnigan/wiki/PeakList
updated: 2011-04-03 15:57:52
...
The peak list is an optional part of the [ScanDataPacket](ScanDataPacket.md) structure. It starts with the peak count value, which determines the number of (*M/z*, intensity) pairs in the list, both of which are floating-point values.
...
| . . . |
| Peak *n* (M/z: Float32, Intensity: Float32) |
