---
title: PascalStringWin32
original: https://code.google.com/p/unfinnigan/wiki/PascalStringWin32
updated: 2010-03-08 08:44:45
...
[Finnigan::Decoder](../decoder-api/FinniganDecoder.md) has the following case for unpacking the template named `varstr` (which corresponds to PascalStringWin32 in Hachoir):
