---
title: ScanEventHierarchy
original: https://code.google.com/p/unfinnigan/wiki/ScanEventHierarchy
updated: 2011-04-01 08:30:04
...
| 64931690 | 80 | [ScanEventPreamble](ScanEventPreamble.md) | `preamble` | `FTMS + p ESI Full ms` |
| 64931770 | 4 | UInt32 | `unknown long[1]` | `0` |
| 64931774 | 4 | UInt32 | `unknown long[2]` | `1` |
| 64931778 | 16 | [FractionCollector](FractionCollector.md) | `fraction collector` | `[300.00-1500.00]` |
...
|  |  | [ScanEventTemplate](ScanEventTemplate.md) (2,1) |  |  |
| 64931810 | 80 | [ScanEventPreamble](ScanEventPreamble.md) | `preamble` | `FTMS + p ESI Full ms` |
| 64931890 | 4 | UInt32 | `unknown long[1]` | `0` |
| 64931894 | 4 | UInt32 | `unknown long[2]` | `1` |
| 64931898 | 16 | [FractionCollector](FractionCollector.md) | `fraction collector` | `[300.00-1500.00]` |
| 64931914 | 4 | UInt32 | `unknown long[3]` | `0` |
| 64931918 | 4 | UInt32 | `unknown long[4]` | `0` |
| 64931922 | 4 | UInt32 | `unknown long[5]` | `0` |
|  |  | [ScanEventTemplate](ScanEventTemplate.md) (2,2) |  |  |
| 64931926 | 80 | [ScanEventPreamble](ScanEventPreamble.md) | `preamble` | `FTMS + p ESI d SIM ms` |
| 64932006 | 4 | UInt32 | `unknown long[1]` | `0` |
| 64932010 | 4 | UInt32 | `unknown long[2]` | `1` |
| 64932014 | 16 | [FractionCollector](FractionCollector.md) | `fraction collector` | `[50.00-150.00]` |
| 64932030 | 4 | UInt32 | `unknown long[3]` | `0` |
| 64932034 | 4 | UInt32 | `unknown long[4]` | `0` |
| 64932038 | 4 | UInt32 | `unknown long[5]` | `0` |
|  |  | [ScanEventTemplate](ScanEventTemplate.md) (2,3) |  |  |
| 64932042 | 80 | [ScanEventPreamble](ScanEventPreamble.md) | `preamble` | `ITMS + c ESI d Full ms2` |
| 64932122 | 4 | UInt32 | `unknown long[1]` | `0` |
| 64932126 | 4 | UInt32 | `unknown long[2]` | `1` |
| 64932130 | 16 | [FractionCollector](FractionCollector.md) | `fraction collector` | `[300.00-2000.00]` |
| 64932146 | 4 | UInt32 | `unknown long[3]` | `0` |
| 64932150 | 4 | UInt32 | `unknown long[4]` | `0` |
| 64932154 | 4 | UInt32 | `unknown long[5]` | `0` |
|  |  | [ScanEventTemplate](ScanEventTemplate.md) (2,4) |  |  |
| 64932158 | 80 | [ScanEventPreamble](ScanEventPreamble.md) | `preamble` | `FTMS + p ESI d SIM ms` |
| 64932238 | 4 | UInt32 | `unknown long[1]` | `0` |
| 64932242 | 4 | UInt32 | `unknown long[2]` | `1` |
| 64932246 | 16 | [FractionCollector](FractionCollector.md) | `fraction collector` | `[50.00-150.00]` |
| 64932262 | 4 | UInt32 | `unknown long[3]` | `0` |
| 64932266 | 4 | UInt32 | `unknown long[4]` | `0` |
| 64932270 | 4 | UInt32 | `unknown long[5]` | `0` |
|  |  | [ScanEventTemplate](ScanEventTemplate.md) (2,5) |  |  |
| 64932274 | 80 | [ScanEventPreamble](ScanEventPreamble.md) | `preamble` | `ITMS + c ESI d Full ms2` |
| 64932354 | 4 | UInt32 | `unknown long[1]` | `0` |
| 64932358 | 4 | UInt32 | `unknown long[2]` | `1` |
| 64932362 | 16 | [FractionCollector](FractionCollector.md) | `fraction collector` | `[300.00-2000.00]` |
| 64932378 | 4 | UInt32 | `unknown long[3]` | `0` |
| 64932382 | 4 | UInt32 | `unknown long[4]` | `0` |
| 64932386 | 4 | UInt32 | `unknown long[5]` | `0` |
|  |  | [ScanEventTemplate](ScanEventTemplate.md) (2,6) |  |  |
| 64932390 | 80 | [ScanEventPreamble](ScanEventPreamble.md) | `preamble` | `FTMS + p ESI d SIM ms` |
| 64932470 | 4 | UInt32 | `unknown long[1]` | `0` |
| 64932474 | 4 | UInt32 | `unknown long[2]` | `1` |
| 64932478 | 16 | [FractionCollector](FractionCollector.md) | `fraction collector` | `[50.00-150.00]` |
| 64932494 | 4 | UInt32 | `unknown long[3]` | `0` |
| 64932498 | 4 | UInt32 | `unknown long[4]` | `0` |
| 64932502 | 4 | UInt32 | `unknown long[5]` | `0` |
|  |  | [ScanEventTemplate](ScanEventTemplate.md) (2,7) |  |  |
| 64932506 | 80 | [ScanEventPreamble](ScanEventPreamble.md) | `preamble` | `ITMS + c ESI d Full ms2` |
| 64932586 | 4 | UInt32 | `unknown long[1]` | `0` |
| 64932590 | 4 | UInt32 | `unknown long[2]` | `1` |
| 64932594 | 16 | [FractionCollector](FractionCollector.md) | `fraction collector` | `[300.00-2000.00]` |
...
[Finnigan::ScanEventTemplate](../decoder-api/FinniganScanEventTemplate.md) (decoder object)
