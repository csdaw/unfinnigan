---
title: InstID
original: https://code.google.com/p/unfinnigan/wiki/InstID
updated: 2011-03-28 13:02:11
...
| --- | --- | --- | --- | --- |
| 0 | 8 | [RawBytes](RawBytes.md) | `unknown data` | `31` |
| 8 | 4 | UInt32 | `unknown long[1]` | `0` |
| 12 | 10 | [PascalStringWin32](PascalStringWin32.md) | `model[1]` | `LTQ` |
| 22 | 10 | [PascalStringWin32](PascalStringWin32.md) | `model[2]` | `LTQ` |
| 32 | 18 | [PascalStringWin32](PascalStringWin32.md) | `serial number` | `1234567` |
| 50 | 54 | [PascalStringWin32](PascalStringWin32.md) | `software version` | `1.0 Beta 12 (HB 03-12-04)` |
| 104 | 4 | [PascalStringWin32](PascalStringWin32.md) | `tag[1]` | `` |
| 108 | 4 | [PascalStringWin32](PascalStringWin32.md) | `tag[2]` | `` |
| 112 | 4 | [PascalStringWin32](PascalStringWin32.md) | `tag[3]` | `` |
| 116 | 4 | [PascalStringWin32](PascalStringWin32.md) | `tag[4]` | `` |
