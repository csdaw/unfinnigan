---
title: ScanEventPreamble
original: https://code.google.com/p/unfinnigan/wiki/ScanEventPreamble
updated: 2010-03-18 07:18:23
author: selko...@gmail.com
source: Internet Archive copy of Google Code wiki
---

This fixed-size structure is a byte array at the head of [ScanEvent](ScanEvent.md). It contains various boolean flags an enumerated types with a small number of values.

A large number of the values in ScanEventPreamble remain unknown.

The structure seems to have grown historically; to the 41 bytes in v.57, 39 more are added in v.62, and 8 further bytes are added in v.63.
