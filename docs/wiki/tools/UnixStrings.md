---
title: UnixStrings
original: https://code.google.com/p/unfinnigan/wiki/UnixStrings
updated: 2012-06-29 09:13:56
author: selko...@gmail.com
source: Internet Archive copy of Google Code wiki
---

***Note:*** In OSX, there is a bastardised version of `strings` without the `-e` option. Instead, better alias `strings` to `/opt/local/bin/gstrings` installed from MacPorts.
