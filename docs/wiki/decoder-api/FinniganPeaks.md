---
title: FinniganPeaks
original: https://code.google.com/p/unfinnigan/wiki/FinniganPeaks
updated: 2011-04-04 06:37:25
...
- **all**
> Get the reference to an array containing the pairs of [*M/z*, abundance] values of each centroided peak. This method avoids the expense of calling the [Finnigan::Peak](FinniganPeak.md) accessors.
