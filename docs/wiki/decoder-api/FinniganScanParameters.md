---
title: FinniganScanParameters
original: https://code.google.com/p/unfinnigan/wiki/FinniganScanParameters
updated: 2011-07-28 07:54:43
...
This decoder augments the [GenericRecord](../structures/GenericRecord.md) decoder with the `charge_state()` method.
...
The purpose of this stream is to provide pre-formatted human-readable messages describing the scan data; The `charge_state` element seems to be unique in that it either does not exist anywhere else, or has not been discovered so far.
