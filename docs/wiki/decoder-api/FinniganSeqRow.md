---
title: FinniganSeqRow
original: https://code.google.com/p/unfinnigan/wiki/FinniganSeqRow
updated: 2011-07-28 05:01:44
...
Decodes the data describing the injection that delivered the sample for analysis to the mass specrometer. The data includes the numeric values bundled in the [Finnigan::InjectionData](FinniganInjectionData.md) object, accompanied by an array of text tags. The recent format versions also include an integer number of unknown meaning.
...
[SeqRow](../structures/SeqRow.md) (structure)
