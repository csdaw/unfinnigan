---
title: WikiHome
original: https://code.google.com/p/unfinnigan/wiki/WikiHome
updated: 2011-06-19 11:33:21
...
I have received a few stripped-down samples of the new **v.64** Finnigan format. It seems to be essentially the same as **v.63**, with the only difference that the 32-bit seek addresses and offsets used in the earlier format are now replaced with the 64-bit ones. I have updated both the [finnigan.py](../tools/HachoirParser.md) and the [Perl API](../decoder-api/DecoderTOC.md) to work with the new format, but it may be too early to claim success, without further testing. If you would like to contribute a sample, please put it somewhere I can grab it.
